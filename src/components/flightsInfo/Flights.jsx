...
export const Flights = () => {
  ...
  const handleChange = (event) => {
    ...
    if (event.target.name === "out") {
      setOutDate(
        new Date(event.target.value).toLocaleDateString("es-ES", opcionesFecha)
      );
      ...
      <div className="form">
        ...
        <div className="form-inputs">
          <div className="inp origin">
            {origPlaceSelect ? (
              <h1 className="orig">{origPlaceSelect}</h1>
            ) : (
            ...
            <button
              ...
              className="butt or"
            >
              {origPlaceSelect === "---" ? "Seleccione un origen" : "Origen"}
            </button>
          </div>
          {placeModal !== "" && (
            <>
          ...
          <div className="inp destination">
            {destPlaceSelect ? (
              <h1 className="destin">{destPlaceSelect}</h1>
            ) : (
              <h1 className="lines">---</h1>
            )}
            <button
              ...
              className="butt dest"
            >
              {destPlaceSelect === "---" ? "Seleccione un destino" : "Destino"}
            </button>
          </div>
          {placeModal !== "" && (
            <>
          ...
          <div className="inp passengers">
            <span>Pasajeros</span>
            <button onClick={() => passengers()} name="pass" className="butt">
